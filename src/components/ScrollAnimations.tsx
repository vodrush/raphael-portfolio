...
const ScrollAnimations: React.FC<ScrollAnimationsProps> = ({ children }) => {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      // CTA buttons — stagger with scale
      ...
      // =============================================
      // SCROLL PROGRESS — gradient shift on scroll
      // =============================================
    ...
    // =============================================
    // LAZY COMPONENTS — MutationObserver to detect
    // when Suspense resolves and components mount
    // =============================================
    ...
    const initScrollAnimations = () => {
      ...
      gsap.context(() => {
        ...
        // =============================================
        // ABOUT CONTENT — horizontal wipe from left (typewriter feel)
        // =============================================
        ...
        // =============================================
        // SKILL ITEMS — fade in with subtle scale
        // =============================================
        ...
        // =============================================
        // SKILL ICONS — continuous subtle pulse
        // =============================================
        ...
        // =============================================
        // PROJECT CARDS — fade in with subtle scale
        // =============================================
        ...
        // =============================================
        // LEARNING ITEMS — fade in with subtle x offset
        // =============================================
        ...
        // Contact form inputs — alternating subtle slide
        ...
        // Footer social icons — continuous rotation
        ...
        // =============================================
        // MICRO-INTERACTIONS — hover effects (SLOW)
        // =============================================
        ...
        // CTA buttons — magnet effect (stronger)
        ...
        // =============================================
        // PARALLAX LAYERS — multiple elements
        // =============================================
        ...
        // Refresh ScrollTrigger after scroll animations are set up
        ScrollTrigger.refresh();

      }, containerRef.current || undefined);
    };

    // Watch for lazy-loaded components to appear in the DOM
    const targetNode = containerRef.current || document.body;

    // Check immediately in case components are already loaded
    if (document.querySelector('[data-gsap="about-content"]')) {
          ...
          for (const node of mutation.addedNodes) {
            if (node instanceof HTMLElement) {
              if (
                ...
                // Small delay to let React finish rendering the full subtree
      ...
      // Fallback: force init after 3s if observer never fires

    ...
    <section id="privacy" className="privacy-policy" ref={ref}>
      <div className={`section-title-container ${inView ? 'is-visible' : ''}`}>
        <div className="section-header">
          <div className="section-tag">Confidentialité</div>
      ...
      <div className={`privacy-content ${inView ? 'is-visible' : ''}`}>
        ...
        <h3>Contact</h3>
        <p>
          Pour toute question concernant cette politique de confidentialité, contactez-moi via le
          formulaire de contact du portfolio.
        </p>
        <p className="last-updated">Dernière mise à jour : Mai 2026</p>
      </div>
    </section>
  );
};
